...
// lineSetCallQualityOfService handler
//
...
$$IF(VERBOSE)
/*****************************************************************************
** Procedure:  $$LINE_CLASS_NAME$$::OnSetQualityOfService
**
...
** Returns:    void
**
** Description:  This function manages the lineSetCallQualityOfService 
**               processing for this service provider.
**
*****************************************************************************/
$$ENDIF
bool $$LINE_CLASS_NAME$$::OnSetQualityOfService(RTSetQualityOfService* pRequest, LPCVOID lpBuff)
{
...
$$ENDIF
	...
	{
		// TODO: Send the QOS request to the hardware using the requested 
		// FLOWSPEC buffers in the pRequest object.
	}
...
}// $$LINE_CLASS_NAME$$::OnSetQualityOfService
