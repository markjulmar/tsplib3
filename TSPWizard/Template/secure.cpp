...
$$IF(VERBOSE)
/*****************************************************************************
** Procedure:  $$LINE_CLASS_NAME$$::OnSecureCall
**
...
** Returns:    void
**
** Description:  This function manages the lineSecureCall processing
**               for this service provider.
**
*****************************************************************************/
$$ENDIF
bool $$LINE_CLASS_NAME$$::OnSecureCall(RTSecureCall* pRequest, LPCVOID lpBuff)
{
...
$$ENDIF
	...
	{
		// TODO: Send a command to secure the media stream for this call against
		// interruption.
	}
...
$$ENDIF
	else if (pRequest->GetState() == STATE_WAITING && lpBuff != NULL)
	{
		...
		if (!fError)
		{
			// TSP++ will automatically mark the call as "secured".
