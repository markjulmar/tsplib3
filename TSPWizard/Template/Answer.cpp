...
$$IF(VERBOSE)
/*****************************************************************************
** Procedure:  $$LINE_CLASS_NAME$$::OnAnswer
**
...
*****************************************************************************/
$$ENDIF
bool $$LINE_CLASS_NAME$$::OnAnswer(RTAnswer* pRequest, LPCVOID lpBuff)
{
...
$$ENDIF
	...
	{
		// TODO: Send a command to answer the given call
	}
