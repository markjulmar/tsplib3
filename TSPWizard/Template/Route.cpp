...
$$IF(VERBOSE)
/*****************************************************************************
** Procedure:  $$LINE_CLASS_NAME$$::OnRedirect
**
** Arguments: 'pReq' - Request object representing this REDIRECT event 
**            'lpBuff' - The event block pointer
**
** Returns:    void
**
** Description:  This function manages the TSPI_lineRedirect processing for 
**               this service provider.
**
*****************************************************************************/
$$ENDIF
bool $$LINE_CLASS_NAME$$::OnRedirect(RTRedirect* pRequest, LPCVOID lpBuff)
{
...
$$ENDIF
	...
	{
		// TODO: Send a command to redirect the call to the given destination
	}
