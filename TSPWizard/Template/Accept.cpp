...
$$IF(VERBOSE)
/*****************************************************************************
** Procedure:  $$LINE_CLASS_NAME$$::OnAccept
**
...
*****************************************************************************/
$$ENDIF
bool $$LINE_CLASS_NAME$$::OnAccept(RTAccept* pRequest, LPCVOID lpBuff)
{
...
$$ENDIF
	...
	{
		// TODO: Send a command to accept the call and allow it to start
		// ringing on the line device.
	}
