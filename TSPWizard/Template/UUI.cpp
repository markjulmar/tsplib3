...
$$IF(VERBOSE)
/*****************************************************************************
** Procedure:  $$LINE_CLASS_NAME$$::OnSendUUI
**
...
*****************************************************************************/
$$ENDIF
bool $$LINE_CLASS_NAME$$::OnSendUUI(RTSendUserInfo* pRequest, LPCVOID lpBuff)
{
...
$$ENDIF
	...
	{
		// TODO: Send a command to send the UUI on the given call path.
	}
