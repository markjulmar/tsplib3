...
$$IF(VERBOSE)
/*****************************************************************************
** Procedure:  $$PHONE_CLASS_NAME$$::OnSetGain
**
...
** Returns:    void
**
** Description:  This function manages the phoneSetGain processing
**               for this service provider.
**
*****************************************************************************/
$$ENDIF
bool $$PHONE_CLASS_NAME$$::OnSetGain(RTSetGain* pRequest, LPCVOID lpBuff)
{
...
$$ENDIF
	if (pRequest->EnterState(STATE_INITIAL, STATE_WAITING))
	{
		...
		DWORD dwGain = pRequest->GetGain();
		// TODO: Adjust the gain of the given device. TSP++ has validated that
		// the device's gain can be set (although not necessarily at this moment in
