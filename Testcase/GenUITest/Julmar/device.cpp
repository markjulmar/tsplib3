...
{
	reinterpret_cast<CTestTspDevice*>(pParam)->ConnectionThread();
	_endthreadex(0);
	return 0;
...
/*****************************************************************************
** Procedure:  CTestTspDevice::CTestTspDevice
**
** Arguments:  void
**
** Returns:    void
...
**
*****************************************************************************/
CTestTspDevice::CTestTspDevice() : m_hConnThread(0)
{
...
**
*****************************************************************************/
bool CTestTspDevice::Init(DWORD dwProviderId, DWORD dwBaseLine, DWORD dwBasePhone, 
...
/*****************************************************************************
** Procedure:  CTestTspDevice::ConnectionThread
**
** Arguments:  void
**
...
**
*****************************************************************************/
unsigned CTestTspDevice::ConnectionThread()
{
...
}// CTestTspDevice::ConnectionThread

/*****************************************************************************
** Procedure:  CTestTspDevice::LocateOwnerFromEvent
**
...
**
*****************************************************************************/
CTSPIConnection* CTestTspDevice::LocateOwnerFromEvent(LPCVOID pEvent)
{
...
}// CTestTspDevice::LocateOwnerFromEvent
